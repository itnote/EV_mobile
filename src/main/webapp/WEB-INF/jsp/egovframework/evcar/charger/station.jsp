    ...
    <p class="location"><a href="javascript:;" onclick="setCenter()">현재위치<i class="fi icon-location"></i></a></p>
        <div class="filter">
            ...
            <ul class="check">
                ...
                <li><input id="stat03" type="checkbox" checked><label class="stat03" for="stat03">점검중/통신장애</label>
                <li><input id="stat04" type="checkbox" checked><label class="stat04" for="stat04">운영중지</label>
                <li><input id="stat05" type="checkbox" checked><label class="stat05" for="stat05">시범운영</label>
                <li><input id="stat06" type="checkbox" checked><label class="stat06" for="stat06">기타(상태미확인)</label>
            </ul>
        </div>
</div>
<style type="text/css">
